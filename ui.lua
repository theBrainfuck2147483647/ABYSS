...
library.theme = {
    ...
    accentcolor = Color3.fromRGB(90, 86, 171),
    accentcolor2 = Color3.fromRGB(90, 86, 171),
...
function library:CreateWatermark(name, position)
    ...
    watermark.text = "picohook " .. name:gsub("{game}", gamename):gsub("{fps}", "0 FPS") .. " "
...
function library:CreateWindow(name, size, hidebutton)
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateConfigSystem(side)
            ...
            local Config = configSystem.sector:AddDropdown("config list", {}, default, false, function() end, "")
